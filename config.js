...
module.exports = {
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Achutty' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Achutty' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/3cdb1ef0595123f13352c.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Achutty' : process.env.LOGO_NAME,
